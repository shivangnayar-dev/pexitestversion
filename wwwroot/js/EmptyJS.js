        ...
        success: function (response) {
            if (response.isValid) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        console.log('Question data added successfully:', response);
                ...
                onNextQuestion = function () {
                    ...
                    if (currentQuestionIndex < totalQuestions - 1) {
                        // If there are more questions, continue to the next one
                        const nextQuestionIndex = currentQuestionIndex + 1;
                        const [nextQuestionId, nextQuestion] = questionOptionsAndAnswers[nextQuestionIndex];
                        giveTest(nextQuestionId, nextQuestion.question, nextQuestion.optionsAndAnswerIds, onNextQuestion, nextQuestionIndex, totalQuestions);
                        ...
                        // If all questions are submitted, do something or end the test
                        let testInProgress = false;
                ...
                // Start with the question where the user left off
